...
REGULATOR_INIT(ldo1, "VMIPI_1.8V", 1700000, 1700000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo6, "VCC_1.8V_AP", 1700000, 1700000, 1, 0, 0);
REGULATOR_INIT(ldo7, "CAM_SENSOR_CORE_1.2V", 1100000, 1100000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo8, "VUOTG_3.0V", 2900000, 2900000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo11, "VMIPI_1.0V", 1000000, 1000000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo12, "VT_CAM_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo13, "VCC_3.3V_LCD", 3200000, 3200000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo14, "VCC_1.8V_IO", 1700000, 1700000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo15, "VDD_2.2V_LCD", 2200000, 2100000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo16, "CAM_ISP_SENSOR_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo17, "CAM_AF_2.8V", 2700000, 2700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo18, "TSP_AVDD_3.3V", 3200000, 3200000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
...
REGULATOR_INIT(ldo3, "VCC_1.8V_AP", 1750000, 1750000, 1, 0, 0);
REGULATOR_INIT(ldo5, "VCC_1.8V_IO", 1750000, 1750000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo8, "VMIPI_1.0V", 1000000, 1000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo9, "CAM_ISP_MIPI_1.2V", 1150000, 1150000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo10, "VMIPI_1.8V", 1750000, 1750000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo11, "VABB1_1.95V", 1850000, 1850000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo12, "VUOTG_3.0V", 2900000, 2900000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
#if defined(CONFIG_MACH_C1_KOR_SKT) || defined(CONFIG_MACH_C1_KOR_KT) || \
	defined(CONFIG_MACH_C1_KOR_LGT) || defined(CONFIG_MACH_C1) || \
	defined(CONFIG_MACH_M0_DUOSCTC) || defined(CONFIG_MACH_M0_GRANDECTC)
REGULATOR_INIT(ldo13, "VUSBHUB_OSC_1.8V", 1750000, 1750000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo14, "VABB2_1.95V", 1750000, 1750000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo17, "CAM_SENSOR_CORE_1.2V", 1150000, 1150000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo18, "CAM_ISP_SENSOR_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo19, "VT_CAM_1.8V", 1750000, 1750000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo21, "VTF_2.8V", 2750000, 2750000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo23, "TSP_AVDD_3.3V", 3250000, 3250000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#if defined(CONFIG_MACH_C1) || \
	defined(CONFIG_MACH_M3) || \
	defined(CONFIG_MACH_M0) || \
	defined(CONFIG_MACH_GC1) || defined(CONFIG_MACH_T0) ||\
	defined(CONFIG_MACH_SLP_T0_LTE)
REGULATOR_INIT(ldo24, "VDD_1.8V_TSP", 1750000, 1750000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#else
REGULATOR_INIT(ldo24, "VDD_2.2V_LCD", 2000000, 2000000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo25, "VCC_3.3V_LCD", 3000000, 3100000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo26, "VCC_MOTOR_3.0V", 2950000, 2950000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
...
REGULATOR_INIT(ldo3, "VCC_1.8V_AP", 1700000, 1700000, 1, 0, 0);
REGULATOR_INIT(ldo8, "VMIPI_1.0V", 1000000, 1000000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo9, "CAM_ISP_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo10, "VT_CAM_DVDD_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo13, "VMIPI_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo19, "CAM_AF_2.8V", 2700000, 2700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo20, "VCC_3.0V_LCD", 2900000, 2900000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo21, "VCC_MOTOR_3.0V", 2900000, 2900000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo22, "CAM_SENSOR_A2.8V", 2700000, 2700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo23, "VTF_2.8V", 2700000, 2700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo24, "TSP_AVDD_3.3V", 3200000, 3200000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo25, "CAM_SENSOR_CORE_1.2V", 1100000, 1100000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo26, "CAM_ISP_SENSOR_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo27, "VT_CAM_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo28, "3_TOUCH_1.8V", 1700000, 1700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
