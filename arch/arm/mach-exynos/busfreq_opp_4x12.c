...
static unsigned int exynos4412_mif_volt[ASV_GROUP][LV_END] = {
	/* 400      400      267      267      160     133     100 */
	{1075000, 1075000, 975000, 975000, 925000, 925000, 925000}, /* RESERVED */  /* EDITED */ 
...
static unsigned int exynos4412_int_volt[ASV_GROUP][LV_END] = {
  /* GDR : 266       200      200     160    160      133     100 */
	...
	{1025000,  975000,  975000, 912500, 912500, 850000, 825000}, /* ASV6 */
...
/* GDR : 266   200     200      160      160     133    100 */
	{0, 1062500, 1062500, 975000, 975000, 950000, 925000}, /* RESERVED */  /* EDITED */
