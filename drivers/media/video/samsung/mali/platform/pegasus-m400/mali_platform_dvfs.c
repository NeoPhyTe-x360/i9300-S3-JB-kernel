...
mali_dvfs_step step[MALI_DVFS_STEPS]={
	...
	/*step 1 clk*/ {266,   800000},
#if (MALI_DVFS_STEPS > 2)
	/*step 2 clk*/ {350,   850000},
#if (MALI_DVFS_STEPS > 3)
	/*step 3 clk*/ {440,  925000},
#if (MALI_DVFS_STEPS > 4)
	/*step 4 clk*/ {533,  975000}
#endif
#endif
#endif
#endif
...
#if (MALI_DVFS_STEPS > 1)
int step1_clk = 266;
int step1_vol = 800000;
int step0_up = 70;
int step1_down = 62;
#if (MALI_DVFS_STEPS > 2)
int step2_clk = 350;
int step2_vol = 850000;
int step1_up = 90;
int step2_down = 85;
#if (MALI_DVFS_STEPS > 3)
int step3_clk = 440;
int step3_vol = 925000;
int step2_up = 90;
int step3_down = 85;
#if (MALI_DVFS_STEPS > 4)
int step4_clk = 533;
int step4_vol = 975000;
int step3_up = 90;
int step4_down = 95;
#endif
#endif
...
static unsigned int asv_3d_volt_9_table_1ghz_type[MALI_DVFS_STEPS-1][ASV_LEVEL] = {
	{  875000,  850000,  850000,  850000,  825000,  825000,  825000,  800000,  800000,  800000,  800000,  775000},  /* L3(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{ 900000,  875000,  875000,  875000,  850000,  850000,  850000,  800000,  800000,  800000,  800000,  775000},  /* L2(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 975000, 950000, 950000, 950000, 900000, 900000, 900000,  875000,  875000,  875000,  875000,  825000},  /* L1(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1025000, 1000000, 1000000, 1000000, 975000, 975000, 975000, 925000, 925000, 925000, 925000,  875000},  /* L0(440Mhz) */
#endif
#endif
#endif
};
...
static unsigned int asv_3d_volt_9_table[MALI_DVFS_STEPS-1][ASV_LEVEL] = {
	{  850000,  825000,  800000,  800000,  775000,  775000,  775000,  775000,  750000,  750000,  750000,  750000},  /* L3(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  875000,  850000,  825000,  825000,  825000,  800000,  800000,  775000,  775000,  775000,  775000,  750000},  /* L2(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 950000, 925000, 900000, 900000,  875000,  850000,  850000,  850000,  825000,  825000,  825000,  800000},  /* L1(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1000000, 975000, 950000, 950000, 950000, 925000, 925000, 900000, 900000, 900000,  875000,  850000},  /* L0(440Mhz) */
#endif
#endif
#endif
};
...
static unsigned int asv_3d_volt_9_table_for_prime[MALI_DVFS_STEPS][ASV_LEVEL_PRIME] = {
	{  850000,  837500,  825000,  812500,  800000,  787500,  775000,  762500,  775000,  762500,  750000,  750000,  750000},  /* L4(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  875000,  862500,  850000,  837500,  825000,  812500,  800000,  787500,  800000,  787500,  775000,  775000,  775000},	/* L3(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 925000, 912500, 900000,  887500,  875000,  862500,  850000,  837500,  850000,  837500,  812500,  800000,  787500},	/* L2(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 987500, 975000, 962500, 950000, 937500, 925000, 912500, 900000, 912500, 900000,  875000,  862500,  850000},	/* L1(440Mhz) */
#if (MALI_DVFS_STEPS > 4)
	{ 1050000, 1037500, 1025000, 1012500, 1000000, 987500, 975000, 962500, 975000, 962500, 937500, 925000, 912500},	/* L0(533Mhz) */
#endif
#endif
#endif
#endif
